...
activities = {
    ...
    "Swimming Club": {
        "description": "Learn swimming techniques and prepare for swim meets",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 16,
        "participants": ["julia@mergington.edu", "ryan@mergington.edu"]
    },
    "Art Club": {
        "description": "Explore drawing, painting, and sculpture in a creative studio",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["nina@mergington.edu", "leo@mergington.edu"]
    },
    "Drama Club": {
        "description": "Develop acting skills and put on school theater productions",
